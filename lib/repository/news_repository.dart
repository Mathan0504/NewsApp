...
class NewsRepository {
  Future<List<NewsModel>> fetchNews() async {
    String url =
        'https://newsapi.org/v2/top-headlines?q=business&languages=en&apiKey=60f1e369450c457eb4402678c2225a28';
  ...
  Future<List<NewsModel>> searchNews({required String query}) async {
    ...
    if (query.isEmpty) {
      url =
          'https://newsapi.org/v2/everything?q=biden&from=2022-07-12&sortBy=popularity&apiKey=60f1e369450c457eb4402678c2225a28';
    } else {
      url =
